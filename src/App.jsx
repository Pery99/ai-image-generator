          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-400 font-light">
                Crafted with precision using modern AI technology
              </p>
            </div>
            
            <nav className="grid grid-cols-2 gap-4 text-center md:text-left">
              <div className="space-y-3">
                <h3 className="text-sm font-medium text-gray-300 uppercase tracking-wider">Product</h3>
              ...
              <div className="space-y-3">
                <h3 className="text-sm font-medium text-gray-300 uppercase tracking-wider">Company</h3>
                <ul className="space-y-2 text-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-center md:justify-end gap-3">
                ...
                <a 
                  href="#" 
                  className="p-3 rounded-xl hover:bg-white/5 transition-all hover:scale-110 hover:shadow-lg hover:shadow-pink-500/20 group" 
